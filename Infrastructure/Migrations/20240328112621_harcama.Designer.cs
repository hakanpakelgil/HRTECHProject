...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240328112621_harcama")]
    partial class harcama
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserHarcama", b =>
                {
                    ...
                    b.HasKey("ApplicationUsersId", "HarcamalarId");

                    b.HasIndex("HarcamalarId");

                    b.ToTable("ApplicationUserHarcama");
                });

            modelBuilder.Entity("ApplicationUserIzin", b =>
                {
                    b.Property<string>("ApplicationUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("IzinlerId")
                        .HasColumnType("int");

                    b.HasKey("ApplicationUsersId", "IzinlerId");

                    b.HasIndex("IzinlerId");

                    b.ToTable("ApplicationUserIzin");
                });
            ...
            modelBuilder.Entity("ApplicationUserHarcama", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.Harcama", null)
                        .WithMany()
                        .HasForeignKey("HarcamalarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ApplicationUserIzin", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.Izin", null)
                        .WithMany()
                        .HasForeignKey("IzinlerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
